...
public class Renderer implements Serializable {
    /**
       * 
       */
    private static final long serialVersionUID = 5492762669681600000L;
    ...
    public void render(LogStatistics allOfTime, LogStatistics lastWindow)
        ...
        output = output.replace("${frequentIpAddressTable}",
                frequentIpAddressTable(allOfTime, lastWindow));
