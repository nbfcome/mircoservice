...
public class Functions {
    ...
    public static final class ComputeRunningSum implements
    ...
    public static final class ResponseCodeTuple implements
            PairFunction<ApacheAccessLog, Integer, Long> {
        /**
         * 
         */
        private static final long serialVersionUID = 1L;
    ...
    public static final class IpCountGreaterThan10 implements
            Function<Tuple2<String, Long>, Boolean> {
        /**
         * 
         */
        private static final long serialVersionUID = 1L;
