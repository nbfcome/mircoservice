...
public class LogAnalyzerAppMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JavaDStream<ApacheAccessLog> accessLogsDStream = logData.map(
                new Functions.ParseFromLogLine()).cache();
        ...
        logAnalyzerTotal.processAccessLogs(Flags.getInstance().getOutputDirectory(),
                accessLogsDStream);

        // Calculate statistics for the last time interval.
        logAnalyzerWindowed.processAccessLogs(Flags.getInstance().getOutputDirectory(),
                accessLogsDStream);
        ...
        accessLogsDStream.foreachRDD(new Function<JavaRDD<ApacheAccessLog>, Void>() {
            private static final long serialVersionUID = -583086356087470826L;
